    ...
    internal sealed class StandardlyGenerateCommand : BaseCommand<StandardlyGenerateCommand>
    {
        ...
        protected override async Task ExecuteAsync(OleMenuCmdEventArgs e)
        {
            try
            {
                ...
                ICodeGenerationBroker codeGenerationBroker = new CodeGenerationBroker();
                ITemplateService templateService = new TemplateService(codeGenerationBroker);

                var frmGenerate = new frmGenerate(settings, templateService);
