...
namespace Standardly.Models.Settings
{
    public class ProjectInfo
    {
        ...
        public string UnitTestProjectFile { get; set; }
        ...
        public string AcceptanceTestProjectFile { get; set; }
        ...
        public string InfrastructureBuildProjectFile { get; set; }
        ...
        public string InfrastructureProvisionProjectFile { get; set; }
